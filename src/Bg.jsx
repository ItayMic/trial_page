           ...
           <div className='middle_div'>
            <div className='right_div'>
             <div className='right_div_inner'>
                  <Download_img show_download_popup_func={show_download_popup_func} title="תמונה חינם" subtitle="תצוגה מקדימה של תמונה" top="true" btn_text="הורד" last_title="איכות טובה עד 0.25 מגה פיקסל"></Download_img>

                  <Download_img title="Pro" subtitle="תמונה מלאה" top="false" btn_text="הורד HD" last_title="האיכות טובה עד 0.25 מגה פיקסל"></Download_img>                  
...
<Download_popup close_popup_func={close_popup_func}> </Download_popup></>: <></>}
